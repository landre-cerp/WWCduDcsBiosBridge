...
internal class CH47F_Listener : AircraftListener
{
    ...
    public CH47F_Listener(ICdu? mcdu, UserOptions options, FrontpanelHub frontpanelHub, bool pilot = true) : base(mcdu, SupportedAircrafts.CH47, options, frontpanelHub)
    {
